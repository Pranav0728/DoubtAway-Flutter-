...
class SignupTPage extends StatefulWidget {
  const SignupTPage({super.key});

  @override
  State<SignupTPage> createState() => _SignupTPageState();
}

class _SignupTPageState extends State<SignupTPage> {
          ...
          CupertinoButton(
              ...
              onPressed: () {
                Navigator.pop(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const LoginTPage()));
              })
        ],
      ),
    );
